...
class GetAllStoriesResponseModel {
  ...
  factory GetAllStoriesResponseModel.fromJson(String str) =>
      GetAllStoriesResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetAllStoriesResponseModel.fromMap(Map<String, dynamic> json) =>
      GetAllStoriesResponseModel(
        error: json["error"],
